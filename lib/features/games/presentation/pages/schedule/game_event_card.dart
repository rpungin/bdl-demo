...
import 'package:bdl_demo/features/games/presentation/pages/schedule/buy_tickets_button.dart';
import 'package:bdl_demo/features/games/presentation/pages/schedule/event_team_logo_view.dart';
import 'package:flutter/material.dart';

class GameEventCard extends StatelessWidget {
  final Game game;
  const GameEventCard({Key? key, required this.game}) : super(key: key);
